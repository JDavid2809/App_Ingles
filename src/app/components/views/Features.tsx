...
import { BookOpen, Clock, MessageCircleMore, Sparkles, UsersRound, Zap } from "lucide-react"
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {features.map((feature, index) => (
                        ...
                        >
                            <div
                                className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-6 transition-all duration-300 ${hoveredFeature === index ? "bg-[#e30f28] text-white scale-110" : "bg-[#e30f28]/10 text-[#e30f28]"
                                    }`}
                            >
                                {feature.icon}
                            </div>
                            ...
                            <h3
                                className={`text-xl font-bold mb-4 transition-colors duration-300 ${hoveredFeature === index ? "text-[#e30f28]" : "text-[#00246a]"
                                    }`}
                            >
                                {feature.title}
                            </h3>
