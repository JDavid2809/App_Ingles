...
export default function RegisterForm() {
  ...
  return (
    <div className="relative">
      ...
      <div className="relative border-0 shadow-2xl bg-gradient-to-br from-white/95 via-white/90 to-rose-50/80 backdrop-blur-2xl rounded-3xl overflow-hidden transform hover:scale-[1.02] transition-all duration-700 hover:shadow-rose-200/50">
        ...
        >
          ...
          <button className="w-full relative h-12 md:h-16 text-base md:text-xl font-black rounded-2xl shadow-2xl transform hover:scale-[1.03] hover:-translate-y-2 transition-all duration-500 flex items-center justify-center overflow-hidden group bg-gradient-to-r from-rose-600 via-pink-600 to-rose-700 hover:from-rose-700 hover:via-pink-700 hover:to-red-700 text-white">
            ...
            <div className="relative z-10 flex items-center">
              ...
              <span className="text-xl tracking-wide">Crear Cuenta Gratis</span>
            </div>
