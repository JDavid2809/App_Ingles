...
const frases = ["Trabajo 👷🏻‍♂️", "Viajes ✈️", "Negocios 💼", "Estudios 👩🏻‍🎓", "Vida ♥️"]
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-8">
                        <div className="inline-flex items-center space-x-2 bg-[#e30f28]/10 text-[#e30f28] px-4 py-2 rounded-full text-sm font-medium">
                            <span className="flex"><Star className="mr-1 h-4 w-4"/>Cursos profesionales de Inglés</span>
                        </div>
                            ...
                            <div className="relative h-16 md:h-20 overflow-hidden mt-2">
                                <div
                                    ...
                                    style={{
                                        ...
                                        transform: `translateY(-${currentPhrase * (100 / frases.length)}%)`
                                    }}
                                >
                        ...
                        <p className="text-xl text-gray-600 leading-relaxed max-w-2xl">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugiat, magnam rerum consequuntur
                            nobis omnis ipsam beatae, repellendus sed, saepe quidem ex rem sunt quo optio! Repellendus iusto aliquid tempora error.
                        </p>

                        <div className="flex flex-wrap gap-4">
                            <button className="bg-[#e30f28] text-white px-8 py-4 rounded-full font-medium hover:bg-[#e30f28]/90 transition-colors duration-300">
                                Comenzar Ahora
                            </button>
                            <button className="bg-white border-2 border-[#00246a] text-[#00246a] px-8 py-4 rounded-full font-medium hover:bg-[#00246a] hover:text-white transition-colors duration-300 group flex items-center">
                                <CirclePlay className="mr-2"/>Ver Demo
                            </button>
                        </div>
                        ...
                        <div className="absolute -top-6 -right-6 bg-white p-4 rounded-2xl shadow-xl animate-bounce">
                            <div className="flex items-center space-x-2">
                                ...
                                <div>
                                    ...
                                    <div className="text-lg font-bold text-[#00246a]">6 meses</div>
                                </div>
                            </div>
                        </div>
